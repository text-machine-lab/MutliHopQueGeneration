...
def main(args):
    ...
    def meteor(targets, predictions):
        from pycocoevalcap.meteor.meteor import Meteor
        return {'meteor': 100 * mean([mm.compute_score({i:[(targets[i])]}, {i:[remove_tag_and_strip(predictions[i])]})[0] for i in range(len(targets))])}
    ...
    seqio.TaskRegistry.add(
        ...
        metric_fns=[bleu4, bleu3, bleu2, bleu1, meteor, rouge, t5.evaluation.metrics.bleu, t5.evaluation.metrics.rouge],
